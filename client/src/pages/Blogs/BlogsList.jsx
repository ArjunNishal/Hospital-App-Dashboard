...
const BlogsList = () => {
  ...
  const getallblogs = async () => {
    try {
      let url = `blog/get/blogs?page=${currentPage}&limit=${itemsPerPage}`;
      setloading(true);
                          ...
                          <div className="card shadow">
                            <div className="card-body">
                              <div className="blog-card">
                                ...
                                <span className="badge text-capitalize badge-purple px-3 py-2 bg-soft-primary fw-semibold mt-3">
                                  {bl?.category?.name}
                                </span>
