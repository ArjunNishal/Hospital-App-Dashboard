...
import { closemodalEditConsultant } from "../../../Intoggle";

const EditConsultant = ({ getalladmins, selectedadmin, creatorid }) => {
  ...
  const handleSubmitEdit = async (e) => {
    ...
    try {
      ...
      if (EditFormdata.permissions.length === 0) {
        return Swal.fire({
          icon: "warning",
          title: "Please select atleast one permission for editing consultant.",
        });
      }
      ...
      const response = await axiosInstance.put(
        `admin-role/edit/consultant/${selectedadmin._id}`,
        admindata,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      Swal.fire({
        ...
        text: "You have successfully updated Consultant.",
      });
          ...
          <div className="modal-content">
            <div className="modal-header ">
              ...
              <button
                ...
                id="editConsultantModalbtnclose"
                aria-label="Close"
              />
            </div>
            {/*end modal-header*/}
