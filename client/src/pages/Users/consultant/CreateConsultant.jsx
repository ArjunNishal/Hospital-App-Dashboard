...
const CreateConsultant = ({ getalladmins }) => {
  ...
  const getpermissions = async () => {
    try {
      ...
      const response = await axiosInstance.post(
        ...
        { creatorid: decoded.role === "admin" ? decoded.id : decoded.memberid },
        {
          headers: {
      ...
      const filterpermissions = permissionslistconsultant.filter((el) =>
    ...
    try {
      ...
      if (formData.permissions.length === 0) {
        return Swal.fire({
          icon: "warning",
          title:
            "Please select atleast one permission for creating consultant.",
        });
      }
      ...
      {decoded.permissions.includes("Create Consultants") ? (
        <>
          ...
          <button
            ...
            className="btn-primary btn d-inline mb-md-0 mb-3"
            onClick={openModalCreateAdmin}
          >
            <i className="fa-solid fa-plus"></i> Add Consultant
          </button>
          <div
            ...
            />
                    ...
                    <div className="card">
                      {/* <div className="card-header">
                        <h4 className="card-title">Create New Consultant</h4>
                      </div> */}
                                    ...
                                    return (
                                      ...
                                      >
                                        <input
                                          ...
                                          className="btn-check"
                                          name={el}
                                          id={`btn-check-outlinedconsultantCreate${index}`}
                                          checked={
                                        ...
                                        <label
                                          ...
                                          htmlFor={`btn-check-outlinedconsultantCreate${index}`}
                                        >
                                          {el}
                                        </label>
                                      </div>
