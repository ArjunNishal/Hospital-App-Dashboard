...
const CreateDoctor = ({ getalladmins }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.permissions.length === 0) {
        return Swal.fire({
          icon: "warning",
          title: "Please select atleast one permission for creating Doctor.",
        });
      }
      ...
      Swal.fire({
        ...
        text: "You have successfully created Doctor.",
      });
              ...
              />
                    ...
                    <div className="card">
                      <div className="card-header">
                        <h4 className="card-title">Create New Doctor</h4>
                      </div>
