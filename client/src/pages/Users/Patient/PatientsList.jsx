  ...
  const getalladmins = async () => {
    try {
      ...
      if (role === "superadmin") {
        ...
        params = { role: "patient", adminID: decoded.id };
      } else {
        params = { role: "patient", createdby: decoded?.memberid };
      }

      const response = await axiosInstance.get(
        `admin-role/getpatients?page=${currentPage}&limit=${itemsPerPage}`,
        {
          params: params,
          headers: {
  ...
  const makeBlockUnblockRequest = async (adminId, isBlocked) => {
    try {
      ...
      Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "An error occurred while blocking/unblocking the Patient.",
      });
    }
  };
                ...
                <div className="card">
                  <div className="card-header ">
                    <div className="d-flex justify-content-between flex-wrap  align-items-center ">
                      <h4 className="card-title mb-md-0 mb-3">All Patients</h4>
                      <div
                      ...
                      >
                        ...
                        {decoded.permissions.includes("Create Patient") && (
                          <CreatePatient getalladmins={getalladmins} />
                        )}
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  <img
                                    ...
                                    src={`${renderUrl}uploads/profile/${ad.image}`}
                                    alt="img"
