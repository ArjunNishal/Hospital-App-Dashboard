...
import { closemodalEditAdmin } from "../../../Intoggle";

const EditAdmin = ({ getalladmins, selectedadmin }) => {
  ...
  const handleSubmitEdit = async (e) => {
    ...
    try {
      ...
      if (EditFormdata.permissions.length === 0) {
        return Swal.fire({
          icon: "warning",
          title: "Please select atleast one permission for editing admin.",
        });
      }
      ...
      const response = await axiosInstance.put(
        `admin-role/edit/${selectedadmin._id}`,
        admindata,
        {
          headers: {
      ...
      Swal.fire({
        ...
        text: "You have successfully updated Admin.",
      });
