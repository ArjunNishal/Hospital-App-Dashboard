...
const CreateMasterweek = ({ getallblogs }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!categoryname) {
        Swal.fire({
          icon: "error",
          title: "Enter a valid master week name.",
        });
        return;
      }
      const admindata = {
      ...
      Swal.fire({
        icon: "success",
        title: "Master week Created Successfully",
        text: "You have successfully created master week.",
      });
      ...
      Swal.fire({
        icon: "error",
        title: "master week creation Failed",
    ...
    <>
      ...
      decoded.role === "superadmin" ? (
        <>
          ...
          >
            <i className="fa-solid fa-plus"></i> Create New Master Week
          </button>
          <div
...
export default CreateMasterweek;
